...
interface ProjectStore {
  ...
  // New function that allows editing even committed commits (for manual code editing)
  updateVariantCode: (hash: CommitHash, numVariant: number, code: string) => void;
...
export const useProjectStore = create<ProjectStore>((set) => ({
  ...
  // New function that allows editing even committed commits (for manual code editing in CodeTab)
  updateVariantCode: (hash: CommitHash, numVariant: number, code: string) =>
    set((state) => {
      const commit = state.commits[hash];
